        ...
        private static string GetMultiCompileForward(PackageVersionInfos version, int indent)
        {
            if(version.RP == lilRenderPipeline.LWRP)
            {
                return GenerateIndentText(indent,
                    /* [Apophis] "#pragma multi_compile _ _MAIN_LIGHT_SHADOWS", */
                    /* [Apophis] "#pragma multi_compile _ _MAIN_LIGHT_SHADOWS_CASCADE", */
                    "#pragma multi_compile _ _ADDITIONAL_LIGHTS_VERTEX _ADDITIONAL_LIGHTS",
                    /* [Apophis] "#pragma multi_compile_fragment _ _ADDITIONAL_LIGHT_SHADOWS", */
                    /* [Apophis] "#pragma multi_compile_fragment _ _SHADOWS_SOFT", */
                    "#pragma multi_compile _ _MIXED_LIGHTING_SUBTRACTIVE",
                    /* [Apophis] "#pragma multi_compile _ DIRLIGHTMAP_COMBINED", */
                    /* [Apophis] "#pragma multi_compile _ LIGHTMAP_ON", */
                    "#pragma multi_compile_vertex _ FOG_LINEAR FOG_EXP FOG_EXP2",
            ...
            else if(version.RP == lilRenderPipeline.URP)
            {
                ...
                {
                    return GenerateIndentText(indent,
                        /* [Apophis] "#pragma multi_compile _ _MAIN_LIGHT_SHADOWS _MAIN_LIGHT_SHADOWS_CASCADE _MAIN_LIGHT_SHADOWS_SCREEN", */
                        "#pragma multi_compile _ _ADDITIONAL_LIGHTS_VERTEX _ADDITIONAL_LIGHTS",
                        "#pragma multi_compile _ PROBE_VOLUMES_L1 PROBE_VOLUMES_L2",
                        // Always calculate in vertex shader
                        //"#pragma multi_compile _ EVALUATE_SH_MIXED EVALUATE_SH_VERTEX",
                        /* [Apophis] "#pragma multi_compile_fragment _ _ADDITIONAL_LIGHT_SHADOWS", */
                        /* [Apophis] "#pragma multi_compile_fragment _ _REFLECTION_PROBE_BLENDING", */
                        /* [Apophis] "#pragma multi_compile_fragment _ _REFLECTION_PROBE_BOX_PROJECTION", */
                        /* [Apophis] "#pragma multi_compile_fragment _ _SHADOWS_SOFT", */
                        /* [Apophis] "#pragma multi_compile_fragment _ _SCREEN_SPACE_OCCLUSION", */
                        /* [Apophis] "#pragma multi_compile_fragment _ _DBUFFER_MRT1 _DBUFFER_MRT2 _DBUFFER_MRT3", */
                        "#pragma multi_compile _ _LIGHT_LAYERS",
                        "#pragma multi_compile_fragment _ _LIGHT_COOKIES",
                        "#pragma multi_compile _ _CLUSTER_LIGHT_LOOP",
                        /* [Apophis] "#pragma multi_compile _ LIGHTMAP_SHADOW_MIXING", */
                        /* [Apophis] "#pragma multi_compile _ SHADOWS_SHADOWMASK", */
                        /* [Apophis] "#pragma multi_compile _ DIRLIGHTMAP_COMBINED", */
                        /* [Apophis] "#pragma multi_compile _ LIGHTMAP_ON", */
                        /* [Apophis] "#pragma multi_compile _ DYNAMICLIGHTMAP_ON", */
                        "#pragma multi_compile_vertex _ FOG_LINEAR FOG_EXP FOG_EXP2",
                        "#pragma multi_compile_instancing",
                        "#define LIL_PASS_FORWARD");
                }
